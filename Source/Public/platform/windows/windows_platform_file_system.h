...
struct windows_platform_file_system : public platform_file_system {
    ...
    open_file(const edvar::string_base<platform_base::char_utf16>& path,
    ...
    virtual edvar::value_or_error<platform_base::uint32, file_operation_error>
    read_file(native_file_handle handle, void* buffer, platform_base::uint32 size) override;

    virtual edvar::value_or_error<platform_base::uint32, file_operation_error>
    write_file(native_file_handle handle, const void* buffer, platform_base::uint32 size) override;
    ...
    virtual bool file_exists(const edvar::string_base<platform_base::char_utf16>& path) override;
    virtual edvar::error_result<file_operation_error>
    create_file(const edvar::string_base<platform_base::char_utf16>& path) override;

    virtual edvar::error_result<file_operation_error>
    delete_file(const edvar::string_base<platform_base::char_utf16>& path) override;

    virtual edvar::error_result<file_operation_error>
    move_file(const edvar::string_base<platform_base::char_utf16>& from,
              const edvar::string_base<platform_base::char_utf16>& to) override;
    ...
    virtual bool directory_exists(const edvar::string_base<platform_base::char_utf16>& path) override {}

    // Create a directory at the specified path. If parent directories do not exist, they won't be created.
    // (non-recursive)
    virtual edvar::error_result<file_operation_error>
    create_directory(const edvar::string_base<platform_base::char_utf16>& path) override;

    // Delete a directory at the specified path. Directory must be empty.
    virtual edvar::error_result<file_operation_error>
    delete_directory(const edvar::string_base<platform_base::char_utf16>& path) override;

    virtual edvar::value_or_error<edvar::array<directory_content_entry>, file_operation_error>
    list_directory_contents(const edvar::string_base<platform_base::char_utf16>& path) override;

    virtual edvar::string_base<platform_base::char_utf16> get_current_working_directory() override;
    virtual edvar::string_base<platform_base::char_utf16>
    set_current_working_directory(const edvar::string_base<platform_base::char_utf16>& path) override;

    virtual edvar::string_base<platform_base::char_utf16> get_temp_directory() override {
     ...
     */
    virtual edvar::string_base<platform_base::char_utf16>
    get_special_directory(const edvar::string_base<platform_base::char_utf16>& name) override;
